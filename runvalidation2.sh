...
while true; do
  ...
  CUDA_VISIBLE_DEVICES=3 python -u eval.py --dataset_dir=/mnt/data/Rohit/ACMData/1a_CATVideosTrain/tftest/ --train_log_dir=logs/train/ --number_of_steps=1 --num_batches=8978 --split=validation --eval_log_dir=logs/test/cat/ |& tee -a log_1acat_test
  sleep 20
done
